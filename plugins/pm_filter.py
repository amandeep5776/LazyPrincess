...
async def lazy_answer(client, message):
    ...
    footer_credit = "❚█══<a href='https://t.me/asb_bot_official'>join</a>═══════\n❚█══<a href='https://t.me/asb_bot_official'>join</a>═══════"
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/asb_bot_official/53')
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer('♥️ Thank You asb bot official ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('How To Download From Link', url='https://t.me/asb_bot_official/53')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://t.me/asb_bot_official")
            ],[
                InlineKeyboardButton(text=f"⚡️ join 🦋", url=f"https://t.me/asb_bot_official")
            ...
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"😒 oops! sona, Your requested content named `{movie}` is not available cheak spelling on google is it right?, we are really trying our best to serve you this cotent,can you please provide us some more details related to your query {movie}, \nSend details to Admin : <a href='https://telegram.me/{ADMIN_USRNM}'>**Send here...**</a>\n\n❤ Thank You for the contribution", reply_markup=reply_markup)
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ 2 ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/asb_bot_official/53'),
        ] 
    )
    if offset != "":
